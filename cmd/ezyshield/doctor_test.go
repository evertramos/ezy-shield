...
func TestRunDoctor_WithTempDir(t *testing.T) {
	...
	if err := runDoctor(silentCmd(), dir, "/nonexistent-doctor-test.db", "/nonexistent-doctor.sock", false); err != nil {
...
func TestRunDoctor_JSONOutput(t *testing.T) {
	...
	if err := runDoctor(cmd, dir, "/nonexistent-doctor-test.db", "/nonexistent-doctor.sock", true); err != nil {
