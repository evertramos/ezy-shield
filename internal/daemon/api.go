...
type SocketRequest struct {
	...
	// "arm_keep", "disarm", "feeds_status", "feeds_refresh" — the complete
	// set handleConn dispatches (issue #357: the arm family and "unallow"
	// were missing here; #196 added the feeds pair).
