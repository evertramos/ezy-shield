...
func (d *Daemon) handleConn(ctx context.Context, conn net.Conn) {
	...
	default:
		resp = SocketResponse{Error: fmt.Sprintf("unknown verb %q; valid: status list list_allow events subscribe report arm arm_keep disarm ban unban allow unallow prune", req.Verb)}
	}
